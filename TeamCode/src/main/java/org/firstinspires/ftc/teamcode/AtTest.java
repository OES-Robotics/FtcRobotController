...
public class AtTest extends LinearOpMode {
    ...
    */
    ...
    public void LinearSlideMoving(double power, double time) {
        double linearPower = power / 2f;
        runtime.reset();
